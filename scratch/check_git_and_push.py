...
if git_bin:
    ...
    print("\n--- 🚀 Executing Final Git Commit & Push for Release v1.0 ---")
    commands = [
        [git_bin, "add", "."],
        [git_bin, "commit", "-m", "Mint Leaf AI v1.0 Research Release: Standalone Predict Script, Real SHA256 Registry, and Release Manifest"],
